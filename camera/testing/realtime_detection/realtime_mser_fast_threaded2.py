#!/usr/bin/env python3
"""
Real-time MSER Digit Detection with Small Object Optimization
Optimized MSER parameters for detecting small digits and various sizes
"""
...
class SmallObjectMSERDigitDetector:
    def __init__(self):
    ...
    def preprocess_frame_small_objects(self, frame):
    ...
    def detect_small_objects(self, frame):
        """Detect small objects using optimized MSER parameters"""
        # Preprocess frame
        processed = self.preprocess_frame_small_objects(frame)
...
class SmallObjectMSERThreadedDetector:
    def __init__(self, stream_url="http://192.168.1.100:8080/video"):
        self.stream_url = stream_url
        self.detector = SmallObjectMSERDigitDetector()
    ...
    def detection_worker(self):
        ...
        while self.running:
            try:
                ...
                # Perform detection
                detections = self.detector.detect_small_objects(frame)
    ...
    def run(self):
        ...
        print("Small Object MSER Digit Detection Started")
        ...
        try:
            while True:
                ...
                # Display frame
                cv2.imshow("Small Object MSER Digit Detection", display_frame)
                ...
                if key == ord('q'):
                    ...
                    filename = f"Small_Object_MSER_Detection_{timestamp}.png"
...
if __name__ == "__main__":
    detector = SmallObjectMSERThreadedDetector()
    detector.run()
